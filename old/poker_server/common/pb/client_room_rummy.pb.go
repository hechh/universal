...
const (
	...
	RummyPlayState_Rummy_PLAYSTATE_Half       RummyPlayState = 7 // 玩家同意平分奖池
)
...
type HalfState int32

const (
	HalfState_Init  HalfState = 0 // 默认不平分
	HalfState_Allow HalfState = 1 // 达成平分条件
	HalfState_Try   HalfState = 2 // 尝试平分-只刷新一次倒计时-如果超时依然不生效
	HalfState_Sure  HalfState = 3 // 确认平分-提前结束并平分奖池
)

// Enum value maps for HalfState.
var (
	HalfState_name = map[int32]string{
		0: "Init",
		1: "Allow",
		2: "Try",
		3: "Sure",
	}
	HalfState_value = map[string]int32{
		"Init":  0,
		"Allow": 1,
		"Try":   2,
		"Sure":  3,
...
func (x HalfState) Enum() *HalfState {
	p := new(HalfState)
	*p = x
	return p
}

func (x HalfState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HalfState) Descriptor() protoreflect.EnumDescriptor {
	return file_client_room_rummy_proto_enumTypes[6].Descriptor()
}

func (HalfState) Type() protoreflect.EnumType {
	return &file_client_room_rummy_proto_enumTypes[6]
}

func (x HalfState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HalfState.Descriptor instead.
func (HalfState) EnumDescriptor() ([]byte, []int) {
...
type RummySettlePlayerInfo struct {
	...
	Coin          int64                  `protobuf:"varint,4,opt,name=coin,proto3" json:"coin,omitempty"`                             // 输赢金币=hand_score*底分（points） PR玩法 其他玩法为奖池分
	...
	PicUrl        string                 `protobuf:"bytes,8,opt,name=pic_url,json=picUrl,proto3" json:"pic_url,omitempty"`            // 玩家头像
	Total         int64                  `protobuf:"varint,9,opt,name=total,proto3" json:"total,omitempty"`                           // PR玩法：玩家单场最大输值+累计胜利金额之和 其他玩法：累计积分
	GhostCard     uint32                 `protobuf:"varint,10,opt,name=ghost_card,json=ghostCard,proto3" json:"ghost_card,omitempty"` // 癞子牌
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummySettlePlayerInfo) GetPicUrl() string {
	if x != nil {
		return x.PicUrl
	}
	return ""
...
func (x *RummySettlePlayerInfo) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *RummySettlePlayerInfo) GetGhostCard() uint32 {
	if x != nil {
		return x.GhostCard
	}
	return 0
...
type RummyRoomPlayer struct {
	...
	Total         int64                  `protobuf:"varint,8,opt,name=total,proto3" json:"total,omitempty"`      // 玩家单场最大输值+累计胜利金额之和
	...
	JoinCoin      int64                  `protobuf:"varint,13,opt,name=join_coin,json=joinCoin,proto3" json:"join_coin,omitempty"`             //玩家入桌初始金币值(points)或者总积分（pool，deal)
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyRoomPlayer) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *RummyRoomPlayer) GetJoinCoin() int64 {
	if x != nil {
		return x.JoinCoin
	}
	return 0
...
type RummyRoomData struct {
	...
	Status        RoomStatus             `protobuf:"varint,9,opt,name=status,proto3,enum=poker.RoomStatus" json:"status,omitempty"`                        // 房间状态
	...
	IsGroup       bool                   `protobuf:"varint,12,opt,name=is_group,json=isGroup,proto3" json:"is_group,omitempty"`                            // 是否为小组赛 连续游戏状态
	Records       []*RummyMatchInfo      `protobuf:"bytes,14,rep,name=records,proto3" json:"records,omitempty"`                                            //扩展玩法 游戏记录集合
	IsEnd         bool                   `protobuf:"varint,15,opt,name=is_end,json=isEnd,proto3" json:"is_end,omitempty"`                                  //扩展玩法是否终结比赛
	HalfState     HalfState              `protobuf:"varint,16,opt,name=half_state,json=halfState,proto3,enum=poker.HalfState" json:"half_state,omitempty"` //pool rummy是否允许平分
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyRoomData) GetStatus() RoomStatus {
	if x != nil {
		return x.Status
	}
...
func (x *RummyRoomData) GetIsGroup() bool {
	if x != nil {
		return x.IsGroup
	}
	return false
...
func (x *RummyRoomData) GetRecords() []*RummyMatchInfo {
	if x != nil {
		return x.Records
	}
	return nil
...
func (x *RummyRoomData) GetIsEnd() bool {
	if x != nil {
		return x.IsEnd
	}
	return false
...
func (x *RummyRoomData) GetHalfState() HalfState {
	if x != nil {
		return x.HalfState
	}
...
type RummyMatchInfo struct {
	state         protoimpl.MessageState `xorm:"-"`   
	Players       []*RummySettlePlayerInfo `protobuf:"bytes,14,rep,name=players,proto3" json:"players,omitempty"` //结束战局数据
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}

func (x *RummyMatchInfo) Reset() {
	*x = RummyMatchInfo{}
...
func (x *RummyMatchInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RummyMatchInfo) ProtoMessage() {}

func (x *RummyMatchInfo) ProtoReflect() protoreflect.Message {
	mi := &file_client_room_rummy_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RummyMatchInfo.ProtoReflect.Descriptor instead.
func (*RummyMatchInfo) Descriptor() ([]byte, []int) {
	return file_client_room_rummy_proto_rawDescGZIP(), []int{9}
}

func (x *RummyMatchInfo) GetPlayers() []*RummySettlePlayerInfo {
	if x != nil {
		return x.Players
	}
	return nil
...
type RummyRoomPubData struct {
	...
	Match         *MatchParam            `protobuf:"bytes,7,opt,name=match,proto3" json:"match,omitempty"`                     // 比赛局数信息
	RoomCfg       *RummyConfig           `protobuf:"bytes,10,opt,name=room_cfg,json=roomCfg,proto3" json:"room_cfg,omitempty"` // 桌子配置
	IsGroup       bool                   `protobuf:"varint,12,opt,name=isGroup,proto3" json:"isGroup,omitempty"`               // 是否为小组赛 连续游戏状态
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyRoomPubData) GetIsGroup() bool {
	if x != nil {
		return x.IsGroup
	}
	return false
...
type RummyCommon struct {
	...
	PrizePool     int64                       `protobuf:"varint,17,opt,name=prize_pool,json=prizePool,proto3" json:"prize_pool,omitempty"` // 扩展玩法奖池
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyCommon) GetPrizePool() int64 {
	if x != nil {
		return x.PrizePool
	}
	return 0
...
type RummyJoinRoomReq struct {
	...
	IsReady       bool                   `protobuf:"varint,3,opt,name=is_ready,json=isReady,proto3" json:"is_ready,omitempty"`         // 匹配请求. 入桌自动准备
...
func (x *RummyJoinRoomReq) GetIsReady() bool {
	if x != nil {
		return x.IsReady
	}
	return false
...
func (x *RummyJoinRoomReq) GetCoin() int64 {
	if x != nil {
		return x.Coin
	}
	return 0
...
func (x *RummyQuitRoomRsp) GetCharge() int64 {
	if x != nil {
		return x.Charge
	}
	return 0
...
type RummyStartGameNtf struct {
	...
	PlayerIds     []uint64               `protobuf:"varint,4,rep,packed,name=player_ids,json=playerIds,proto3" json:"player_ids,omitempty"` //当前可游戏玩家总数
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyStartGameNtf) GetPlayerIds() []uint64 {
	if x != nil {
		return x.PlayerIds
	}
	return nil
...
type RummyOprCardRsp struct {
	...
	GaveScore     int64                  `protobuf:"varint,9,opt,name=gave_score,json=gaveScore,proto3" json:"gave_score,omitempty"`                   // 投降分数
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyOprCardRsp) GetGaveScore() int64 {
	if x != nil {
		return x.GaveScore
	}
	return 0
...
type RummyOprCardNtf struct {
	...
	GaveScore     int64                  `protobuf:"varint,10,opt,name=gave_score,json=gaveScore,proto3" json:"gave_score,omitempty"`                  // 投降分数
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyOprCardNtf) GetGaveScore() int64 {
	if x != nil {
		return x.GaveScore
	}
	return 0
...
type RummySettleNtf struct {
	...
	ScorePoll     int64                    `protobuf:"varint,7,opt,name=score_poll,json=scorePoll,proto3" json:"score_poll,omitempty"` // 奖池分数
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummySettleNtf) GetScorePoll() int64 {
	if x != nil {
		return x.ScorePoll
	}
	return 0
...
type RummyPlayerActionNtf struct {
	...
	ScorePoll     int64                  `protobuf:"varint,5,opt,name=score_poll,json=scorePoll,proto3" json:"score_poll,omitempty"`       // 奖池分数
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyPlayerActionNtf) GetScorePoll() int64 {
	if x != nil {
		return x.ScorePoll
	}
	return 0
...
type RummyReadyRoomReq struct {
	state         protoimpl.MessageState `xorm:"-"` 
	RoomId        uint64                 `protobuf:"varint,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`       // 桌子ID
	PlayerId      uint64                 `protobuf:"varint,2,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"` //就绪玩家id
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyReadyRoomReq) GetPlayerId() uint64 {
	if x != nil {
		return x.PlayerId
	}
	return 0
...
type RummyReadyRoomNtf struct {
	state         protoimpl.MessageState `xorm:"-"` 
	RoomId        uint64                 `protobuf:"varint,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`                 // 房间ID
	PlayerId      uint64                 `protobuf:"varint,2,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"`           //就绪当前玩家id
	PlayerIds     []uint64               `protobuf:"varint,3,rep,packed,name=player_ids,json=playerIds,proto3" json:"player_ids,omitempty"` //当前可游戏玩家总数
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}
...
func (x *RummyReadyRoomNtf) GetPlayerIds() []uint64 {
	if x != nil {
		return x.PlayerIds
	}
	return nil
...
func (x *RummyShuffleNtf) Reset() {
	*x = RummyShuffleNtf{}
	mi := &file_client_room_rummy_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RummyShuffleNtf) Descriptor() ([]byte, []int) {
	return file_client_room_rummy_proto_rawDescGZIP(), []int{51}
}
...
// RummyRechargeNtf 准备通知
type RummyRechargeNtf struct {
	state         protoimpl.MessageState `xorm:"-"` 
	RoomId        uint64                 `protobuf:"varint,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`              // 房间ID
	PlayerId      []uint64               `protobuf:"varint,2,rep,packed,name=player_id,json=playerId,proto3" json:"player_id,omitempty"` // 缺少费用玩家id
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}

func (x *RummyRechargeNtf) Reset() {
	*x = RummyRechargeNtf{}
	mi := &file_client_room_rummy_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RummyRechargeNtf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RummyRechargeNtf) ProtoMessage() {}

func (x *RummyRechargeNtf) ProtoReflect() protoreflect.Message {
	mi := &file_client_room_rummy_proto_msgTypes[52]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RummyRechargeNtf.ProtoReflect.Descriptor instead.
func (*RummyRechargeNtf) Descriptor() ([]byte, []int) {
	return file_client_room_rummy_proto_rawDescGZIP(), []int{52}
}

func (x *RummyRechargeNtf) GetRoomId() uint64 {
	if x != nil {
		return x.RoomId
	}
	return 0
...
func (x *RummyRechargeNtf) GetPlayerId() []uint64 {
	if x != nil {
		return x.PlayerId
	}
	return nil
...
// RummyKickPlayerReq 异步移出房间 忽略返回
type RummyKickPlayerReq struct {
	state         protoimpl.MessageState `xorm:"-"` 
	RoomId        uint64                 `protobuf:"varint,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"` // 离开的房间ID
	Charge        int64                  `protobuf:"varint,2,opt,name=charge,proto3" json:"charge,omitempty"`               //  余额
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}

func (x *RummyKickPlayerReq) Reset() {
	*x = RummyKickPlayerReq{}
	mi := &file_client_room_rummy_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RummyKickPlayerReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RummyKickPlayerReq) ProtoMessage() {}

func (x *RummyKickPlayerReq) ProtoReflect() protoreflect.Message {
	mi := &file_client_room_rummy_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RummyKickPlayerReq.ProtoReflect.Descriptor instead.
func (*RummyKickPlayerReq) Descriptor() ([]byte, []int) {
	return file_client_room_rummy_proto_rawDescGZIP(), []int{53}
}

func (x *RummyKickPlayerReq) GetRoomId() uint64 {
	if x != nil {
		return x.RoomId
	}
	return 0
...
func (x *RummyKickPlayerReq) GetCharge() int64 {
	if x != nil {
		return x.Charge
	}
	return 0
...
type RummyRemoveRoomReq struct {
	state         protoimpl.MessageState `xorm:"-"` 
	RoomId        uint64                 `protobuf:"varint,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"` // 回收的房间ID
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}

func (x *RummyRemoveRoomReq) Reset() {
	*x = RummyRemoveRoomReq{}
	mi := &file_client_room_rummy_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RummyRemoveRoomReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RummyRemoveRoomReq) ProtoMessage() {}

func (x *RummyRemoveRoomReq) ProtoReflect() protoreflect.Message {
	mi := &file_client_room_rummy_proto_msgTypes[54]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RummyRemoveRoomReq.ProtoReflect.Descriptor instead.
func (*RummyRemoveRoomReq) Descriptor() ([]byte, []int) {
	return file_client_room_rummy_proto_rawDescGZIP(), []int{54}
}

func (x *RummyRemoveRoomReq) GetRoomId() uint64 {
	if x != nil {
		return x.RoomId
	}
	return 0
...
type RummyRemoveRoomRsp struct {
	state         protoimpl.MessageState `xorm:"-"` 
	Head          *RspHead               `protobuf:"bytes,1,opt,name=head,proto3" json:"head,omitempty"`                    //请求结果信息
	RoomId        uint64                 `protobuf:"varint,2,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"` // 回收的房间ID
	unknownFields protoimpl.UnknownFields `xorm:"-"`
	sizeCache     protoimpl.SizeCache `xorm:"-"`
}

func (x *RummyRemoveRoomRsp) Reset() {
	*x = RummyRemoveRoomRsp{}
	mi := &file_client_room_rummy_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RummyRemoveRoomRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RummyRemoveRoomRsp) ProtoMessage() {}

func (x *RummyRemoveRoomRsp) ProtoReflect() protoreflect.Message {
	mi := &file_client_room_rummy_proto_msgTypes[55]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RummyRemoveRoomRsp.ProtoReflect.Descriptor instead.
func (*RummyRemoveRoomRsp) Descriptor() ([]byte, []int) {
	return file_client_room_rummy_proto_rawDescGZIP(), []int{55}
}

func (x *RummyRemoveRoomRsp) GetHead() *RspHead {
	if x != nil {
		return x.Head
	}
	return nil
...
func (x *RummyRemoveRoomRsp) GetRoomId() uint64 {
	if x != nil {
		return x.RoomId
	}
	return 0
...
var file_client_room_rummy_proto_rawDesc = string([]byte{
	...
	0x0d, 0x52, 0x04, 0x63, 0x61, 0x72, 0x64, 0x22, 0xcb, 0x02, 0x0a, 0x15, 0x52, 0x75, 0x6d, 0x6d,
	...
	0x6e, 0x75, 0x73, 0x43, 0x61, 0x73, 0x68, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x69, 0x63, 0x5f, 0x75,
	0x72, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x69, 0x63, 0x55, 0x72, 0x6c,
	0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x67, 0x68, 0x6f, 0x73, 0x74, 0x5f,
	0x63, 0x61, 0x72, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x67, 0x68, 0x6f, 0x73,
	0x74, 0x43, 0x61, 0x72, 0x64, 0x22, 0xa8, 0x02, 0x0a, 0x16, 0x52, 0x75, 0x6d, 0x6d, 0x79, 0x54,
	0x6f, 0x74, 0x61, 0x6c, 0x53, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72,
	...
	0x52, 0x08, 0x6e, 0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x69,
	0x63, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x69, 0x63,
	0x55, 0x72, 0x6c, 0x12, 0x2b, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x22, 0x45, 0x0a, 0x10, 0x52, 0x75, 0x6d, 0x6d, 0x79, 0x50, 0x6c, 0x61, 0x79,
	0x65, 0x72, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x8e, 0x01, 0x0a, 0x10, 0x52, 0x75,
	0x6d, 0x6d, 0x79, 0x4a, 0x6f, 0x69, 0x6e, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x17,
	0x0a, 0x07, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x0b, 0x70, 0x6c, 0x61, 0x79, 0x65,
	...
	0x0a, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x19, 0x0a, 0x08, 0x69,
	0x73, 0x5f, 0x72, 0x65, 0x61, 0x64, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69,
	0x73, 0x52, 0x65, 0x61, 0x64, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x69, 0x6e, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x63, 0x6f, 0x69, 0x6e, 0x22, 0xc7, 0x01, 0x0a, 0x10, 0x52,
	0x75, 0x6d, 0x6d, 0x79, 0x4a, 0x6f, 0x69, 0x6e, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x73, 0x70, 0x12,
	...
	,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x06, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x22, 0x48, 0x0a,
	0x10, 0x52, 0x75, 0x6d, 0x6d, 0x79, 0x51, 0x75, 0x69, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65,
	0x71, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x73,
	0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69,
	0x73, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x67, 0x0a, 0x10, 0x52, 0x75, 0x6d, 0x6d, 0x79,
	0x51, 0x75, 0x69, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x73, 0x70, 0x12, 0x22, 0x0a, 0x04, 0x68,
	...
	0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x68, 0x61, 0x72,
	0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65,
	0x22, 0x7e, 0x0a, 0x10, 0x52, 0x75, 0x6d, 0x6d, 0x79, 0x51, 0x75, 0x69, 0x74, 0x52, 0x6f, 0x6f,
	0x6d, 0x4e, 0x74, 0x66, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x69, 0x64, 0x18,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x22, 0xbe, 0x02, 0x0a, 0x0f, 0x52, 0x75,
	0x6d, 0x6d, 0x79, 0x4f, 0x70, 0x72, 0x43, 0x61, 0x72, 0x64, 0x52, 0x73, 0x70, 0x12, 0x22, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x14, 0x0a,
	0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x63,
	0x6f, 0x72, 0x65, 0x12, 0x2d, 0x0a, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x04, 0x20,
	...
	0x70, 0x73, 0x22, 0x30, 0x0a, 0x15, 0x52, 0x75, 0x6d, 0x6d, 0x79, 0x47, 0x65, 0x74, 0x53, 0x63,
	0x6f, 0x72, 0x65, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x65, 0x71, 0x12, 0x17, 0x0a, 0x07, 0x72,
	0x6f, 0x6f, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x72, 0x6f,
	0x6f, 0x6d, 0x49, 0x64, 0x22, 0xdc, 0x01, 0x0a, 0x15, 0x52, 0x75, 0x6d, 0x6d, 0x79, 0x47, 0x65,
	0x74, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x73, 0x70, 0x12, 0x22,
	...
	,
	...
	0x04, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x22, 0x60, 0x0a, 0x0e, 0x50, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x4f, 0x75, 0x74, 0x43, 0x61, 0x72, 0x64, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x70,
	...
	0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x61, 0x72, 0x64, 0x73, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x0d, 0x52, 0x05, 0x63, 0x61, 0x72, 0x64, 0x73, 0x22, 0x2e, 0x0a, 0x13, 0x52,
	0x75, 0x6d, 0x6d, 0x79, 0x47, 0x65, 0x74, 0x4f, 0x75, 0x74, 0x43, 0x61, 0x72, 0x64, 0x73, 0x52,
	0x65, 0x71, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x22, 0x6f, 0x0a, 0x13, 0x52,
	0x75, 0x6d, 0x6d, 0x79, 0x47, 0x65, 0x74, 0x4f, 0x75, 0x74, 0x43, 0x61, 0x72, 0x64, 0x73, 0x52,
	...
	,
	...
	0x64, 0x22, 0x51, 0x0a, 0x12, 0x52, 0x75, 0x6d, 0x6d, 0x79, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65,
	...
	,
...
var file_client_room_rummy_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_client_room_rummy_proto_msgTypes = make([]protoimpl.MessageInfo, 58)
var file_client_room_rummy_proto_goTypes = []any{
	...
	(HalfState)(0),                 // 6: poker.HalfState
	(*RummyCardGroup)(nil),         // 7: poker.RummyCardGroup
	(*RummyZhuangCard)(nil),        // 8: poker.RummyZhuangCard
	(*RummySettlePlayerInfo)(nil),  // 9: poker.RummySettlePlayerInfo
	(*RummyTotalSettlePlayer)(nil), // 10: poker.RummyTotalSettlePlayer
	(*RummyScoreBoardPlayer)(nil),  // 11: poker.RummyScoreBoardPlayer
	(*RummyPlayerScore)(nil),       // 12: poker.RummyPlayerScore
	(*RummyRoundSettle)(nil),       // 13: poker.RummyRoundSettle
	(*RummyRoomPlayer)(nil),        // 14: poker.RummyRoomPlayer
	(*RummyRoomData)(nil),          // 15: poker.RummyRoomData
	(*RummyMatchInfo)(nil),         // 16: poker.RummyMatchInfo
	(*RummyRoomPubData)(nil),       // 17: poker.RummyRoomPubData
	(*RummyPrivate)(nil),           // 18: poker.RummyPrivate
	(*RummyCommon)(nil),            // 19: poker.RummyCommon
	(*RummyOprPlayer)(nil),         // 20: poker.RummyOprPlayer
	(*RummyPlayerRumtime)(nil),     // 21: poker.RummyPlayerRumtime
	(*MatchParam)(nil),             // 22: poker.MatchParam
	(*RummyJoinRoomReq)(nil),       // 23: poker.RummyJoinRoomReq
	(*RummyJoinRoomRsp)(nil),       // 24: poker.RummyJoinRoomRsp
	(*RummyEventNotify)(nil),       // 25: poker.RummyEventNotify
	(*RummyEnterDeskNtf)(nil),      // 26: poker.RummyEnterDeskNtf
	(*RummyQuitRoomReq)(nil),       // 27: poker.RummyQuitRoomReq
	(*RummyQuitRoomRsp)(nil),       // 28: poker.RummyQuitRoomRsp
	(*RummyQuitRoomNtf)(nil),       // 29: poker.RummyQuitRoomNtf
	(*RummyReadyStartGameNtf)(nil), // 30: poker.RummyReadyStartGameNtf
	(*RummyStartGameNtf)(nil),      // 31: poker.RummyStartGameNtf
	(*RummySetZhuangNtf)(nil),      // 32: poker.RummySetZhuangNtf
	(*RummyDealNtf)(nil),           // 33: poker.RummyDealNtf
	(*RummyPlayCardNtf)(nil),       // 34: poker.RummyPlayCardNtf
	(*RummyOprCardReq)(nil),        // 35: poker.RummyOprCardReq
	(*RummyOprCardRsp)(nil),        // 36: poker.RummyOprCardRsp
	(*RummyOprCardNtf)(nil),        // 37: poker.RummyOprCardNtf
	(*RummyFixCardReq)(nil),        // 38: poker.RummyFixCardReq
	(*RummyFixCardRsp)(nil),        // 39: poker.RummyFixCardRsp
	(*RummyFixCardPlayersNtf)(nil), // 40: poker.RummyFixCardPlayersNtf
	(*RummySettleNtf)(nil),         // 41: poker.RummySettleNtf
	(*RummyPlayerActionNtf)(nil),   // 42: poker.RummyPlayerActionNtf
	(*RummyGiveUpNtf)(nil),         // 43: poker.RummyGiveUpNtf
	(*RummySaveCardGroupReq)(nil),  // 44: poker.RummySaveCardGroupReq
	(*RummySaveCardGroupRsp)(nil),  // 45: poker.RummySaveCardGroupRsp
	(*RummyGetScoreBoardReq)(nil),  // 46: poker.RummyGetScoreBoardReq
	(*RummyGetScoreBoardRsp)(nil),  // 47: poker.RummyGetScoreBoardRsp
	(*RummyGetLastSettleReq)(nil),  // 48: poker.RummyGetLastSettleReq
	(*RummyGetLastSettleRsp)(nil),  // 49: poker.RummyGetLastSettleRsp
	(*RummyPauseDeskMsgReq)(nil),   // 50: poker.RummyPauseDeskMsgReq
	(*RummyPauseDeskMsgRsp)(nil),   // 51: poker.RummyPauseDeskMsgRsp
	(*PlayerOutCards)(nil),         // 52: poker.PlayerOutCards
	(*RummyGetOutCardsReq)(nil),    // 53: poker.RummyGetOutCardsReq
	(*RummyGetOutCardsRsp)(nil),    // 54: poker.RummyGetOutCardsRsp
	(*RummyReadyRoomReq)(nil),      // 55: poker.RummyReadyRoomReq
	(*RummyReadyRoomRsp)(nil),      // 56: poker.RummyReadyRoomRsp
	(*RummyReadyRoomNtf)(nil),      // 57: poker.RummyReadyRoomNtf
	(*RummyShuffleNtf)(nil),        // 58: poker.RummyShuffleNtf
	(*RummyRechargeNtf)(nil),       // 59: poker.RummyRechargeNtf
	(*RummyKickPlayerReq)(nil),     // 60: poker.RummyKickPlayerReq
	(*RummyRemoveRoomReq)(nil),     // 61: poker.RummyRemoveRoomReq
	(*RummyRemoveRoomRsp)(nil),     // 62: poker.RummyRemoveRoomRsp
	nil,                            // 63: poker.RummyCommon.SeatsEntry
	nil,                            // 64: poker.RummyCommon.PlayersEntry
	(GameState)(0),                 // 65: poker.GameState
	(*RummyMachineConfig)(nil),     // 66: poker.RummyMachineConfig
	(RoomStatus)(0),                // 67: poker.RoomStatus
	(*RummyConfig)(nil),            // 68: poker.RummyConfig
	(RummyRoundStep)(0),            // 69: poker.RummyRoundStep
	(*PlayerInfo)(nil),             // 70: poker.PlayerInfo
	(*RspHead)(nil),                // 71: poker.RspHead
	(RummyEventType)(0),            // 72: poker.RummyEventType
}
var file_client_room_rummy_proto_depIdxs = []int32{
	4,  // 0: poker.RummyCardGroup.group_type:type_name -> poker.RummyGroupType
	7,  // 1: poker.RummySettlePlayerInfo.card_group:type_name -> poker.RummyCardGroup
	...
	12, // 4: poker.RummyRoundSettle.scores:type_name -> poker.RummyPlayerScore
	...
	21, // 7: poker.RummyRoomPlayer.private:type_name -> poker.RummyPlayerRumtime
	65, // 8: poker.RummyRoomData.stage:type_name -> poker.GameState
	19, // 9: poker.RummyRoomData.common:type_name -> poker.RummyCommon
	22, // 10: poker.RummyRoomData.match:type_name -> poker.MatchParam
	66, // 11: poker.RummyRoomData.machine_cfg:type_name -> poker.RummyMachineConfig
	67, // 12: poker.RummyRoomData.status:type_name -> poker.RoomStatus
	68, // 13: poker.RummyRoomData.room_cfg:type_name -> poker.RummyConfig
	18, // 14: poker.RummyRoomData.private:type_name -> poker.RummyPrivate
	16, // 15: poker.RummyRoomData.records:type_name -> poker.RummyMatchInfo
	6,  // 16: poker.RummyRoomData.half_state:type_name -> poker.HalfState
	9,  // 17: poker.RummyMatchInfo.players:type_name -> poker.RummySettlePlayerInfo
	65, // 18: poker.RummyRoomPubData.stage:type_name -> poker.GameState
	19, // 19: poker.RummyRoomPubData.common:type_name -> poker.RummyCommon
	22, // 20: poker.RummyRoomPubData.match:type_name -> poker.MatchParam
	68, // 21: poker.RummyRoomPubData.room_cfg:type_name -> poker.RummyConfig
	63, // 22: poker.RummyCommon.seats:type_name -> poker.RummyCommon.SeatsEntry
	64, // 23: poker.RummyCommon.players:type_name -> poker.RummyCommon.PlayersEntry
	20, // 24: poker.RummyCommon.opr_player:type_name -> poker.RummyOprPlayer
	69, // 25: poker.RummyOprPlayer.step:type_name -> poker.RummyRoundStep
	7,  // 26: poker.RummyPlayerRumtime.card_group:type_name -> poker.RummyCardGroup
	70, // 27: poker.RummyJoinRoomReq.player_info:type_name -> poker.PlayerInfo
	71, // 28: poker.RummyJoinRoomRsp.head:type_name -> poker.RspHead
	17, // 29: poker.RummyJoinRoomRsp.room_info:type_name -> poker.RummyRoomPubData
	72, // 30: poker.RummyEventNotify.Event:type_name -> poker.RummyEventType
	14, // 31: poker.RummyEnterDeskNtf.player:type_name -> poker.RummyRoomPlayer
	71, // 32: poker.RummyQuitRoomRsp.head:type_name -> poker.RspHead
	5,  // 33: poker.RummyQuitRoomNtf.leave_type:type_name -> poker.RummyLeaveType
	8,  // 34: poker.RummySetZhuangNtf.cards:type_name -> poker.RummyZhuangCard
	7,  // 35: poker.RummyDealNtf.groups:type_name -> poker.RummyCardGroup
	3,  // 36: poker.RummyOprCardReq.opr_type:type_name -> poker.RummyOprType
	7,  // 37: poker.RummyOprCardReq.groups:type_name -> poker.RummyCardGroup
	71, // 38: poker.RummyOprCardRsp.head:type_name -> poker.RspHead
	3,  // 39: poker.RummyOprCardRsp.opr_type:type_name -> poker.RummyOprType
	7,  // 40: poker.RummyOprCardRsp.groups:type_name -> poker.RummyCardGroup
	3,  // 41: poker.RummyOprCardNtf.opr_type:type_name -> poker.RummyOprType
	7,  // 42: poker.RummyFixCardReq.groups:type_name -> poker.RummyCardGroup
	71, // 43: poker.RummyFixCardRsp.head:type_name -> poker.RspHead
	7,  // 44: poker.RummyFixCardRsp.groups:type_name -> poker.RummyCardGroup
	9,  // 45: poker.RummySettleNtf.players:type_name -> poker.RummySettlePlayerInfo
	0,  // 46: poker.RummyPlayerActionNtf.type:type_name -> poker.RummyPlayerActionType
	7,  // 47: poker.RummySaveCardGroupReq.groups:type_name -> poker.RummyCardGroup
	71, // 48: poker.RummySaveCardGroupRsp.head:type_name -> poker.RspHead
	7,  // 49: poker.RummySaveCardGroupRsp.groups:type_name -> poker.RummyCardGroup
	71, // 50: poker.RummyGetScoreBoardRsp.head:type_name -> poker.RspHead
	11, // 51: poker.RummyGetScoreBoardRsp.players:type_name -> poker.RummyScoreBoardPlayer
	13, // 52: poker.RummyGetScoreBoardRsp.rounds:type_name -> poker.RummyRoundSettle
	71, // 53: poker.RummyGetLastSettleRsp.head:type_name -> poker.RspHead
	9,  // 54: poker.RummyGetLastSettleRsp.players:type_name -> poker.RummySettlePlayerInfo
	71, // 55: poker.RummyPauseDeskMsgRsp.head:type_name -> poker.RspHead
	71, // 56: poker.RummyGetOutCardsRsp.head:type_name -> poker.RspHead
	71, // 57: poker.RummyReadyRoomRsp.head:type_name -> poker.RspHead
	65, // 58: poker.RummyReadyRoomRsp.stage:type_name -> poker.GameState
	17, // 59: poker.RummyReadyRoomRsp.room_info:type_name -> poker.RummyRoomPubData
	71, // 60: poker.RummyRemoveRoomRsp.head:type_name -> poker.RspHead
	14, // 61: poker.RummyCommon.PlayersEntry.value:type_name -> poker.RummyRoomPlayer
