...
func (x *RummySettlePlayerInfo) SetPicUrl(val string) {
	x.PicUrl = val
}

func (x *RummySettlePlayerInfo) SetTotal(val int64) {
	x.Total = val
}

func (x *RummySettlePlayerInfo) SetGhostCard(val uint32) {
	x.GhostCard = val
}
...
func (x *RummyRoomPlayer) SetTotal(val int64) {
	x.Total = val
}
...
func (x *RummyRoomPlayer) SetJoinCoin(val int64) {
	x.JoinCoin = val
}
...
func (x *RummyRoomData) SetStatus(val RoomStatus) {
	x.Status = val
}
...
func (x *RummyRoomData) SetIsGroup(val bool) {
	x.IsGroup = val
}

func (x *RummyRoomData) SetRecords(val []*RummyMatchInfo) {
	x.Records = val
}

func (x *RummyRoomData) SetIsEnd(val bool) {
	x.IsEnd = val
}

func (x *RummyRoomData) SetHalfState(val HalfState) {
	x.HalfState = val
}
...
func (x *RummyMatchInfo) SetPlayers(val []*RummySettlePlayerInfo) {
	x.Players = val
}

func (x *RummyMatchInfo) FromDB(data []byte) error {
	if len(data) == 0 {
		return nil
	}
	return proto.Unmarshal(data, x)
...
func (x *RummyMatchInfo) ToDB() ([]byte, error) {
	if x == nil {
		return nil, nil
	}
	return proto.Marshal(x)
...
func (x *RummyRoomPubData) SetIsGroup(val bool) {
	x.IsGroup = val
}
...
func (x *RummyCommon) SetPrizePool(val int64) {
	x.PrizePool = val
}
...
func (x *RummyJoinRoomReq) SetIsReady(val bool) {
	x.IsReady = val
}

func (x *RummyJoinRoomReq) SetCoin(val int64) {
	x.Coin = val
}
...
func (x *RummyQuitRoomRsp) SetCharge(val int64) {
	x.Charge = val
}
...
func (x *RummyStartGameNtf) SetPlayerIds(val []uint64) {
	x.PlayerIds = val
}
...
func (x *RummyOprCardRsp) SetGaveScore(val int64) {
	x.GaveScore = val
}
...
func (x *RummyOprCardNtf) SetGaveScore(val int64) {
	x.GaveScore = val
}
...
func (x *RummySettleNtf) SetScorePoll(val int64) {
	x.ScorePoll = val
}
...
func (x *RummyPlayerActionNtf) SetScorePoll(val int64) {
	x.ScorePoll = val
}
...
func (x *RummyReadyRoomReq) SetPlayerId(val uint64) {
	x.PlayerId = val
}
...
func (x *RummyReadyRoomNtf) SetPlayerIds(val []uint64) {
	x.PlayerIds = val
}
...
func (x *RummyRechargeNtf) SetRoomId(val uint64) {
	x.RoomId = val
}

func (x *RummyRechargeNtf) SetPlayerId(val []uint64) {
	x.PlayerId = val
}

func (x *RummyRechargeNtf) FromDB(data []byte) error {
	if len(data) == 0 {
		return nil
	}
	return proto.Unmarshal(data, x)
...
func (x *RummyRechargeNtf) ToDB() ([]byte, error) {
	if x == nil {
		return nil, nil
	}
	return proto.Marshal(x)
...
func (x *RummyKickPlayerReq) SetRoomId(val uint64) {
	x.RoomId = val
}

func (x *RummyKickPlayerReq) SetCharge(val int64) {
	x.Charge = val
}

func (x *RummyKickPlayerReq) FromDB(data []byte) error {
	if len(data) == 0 {
		return nil
	}
	return proto.Unmarshal(data, x)
...
func (x *RummyKickPlayerReq) ToDB() ([]byte, error) {
	if x == nil {
		return nil, nil
	}
	return proto.Marshal(x)
...
func (x *RummyRemoveRoomReq) SetRoomId(val uint64) {
	x.RoomId = val
}

func (x *RummyRemoveRoomReq) FromDB(data []byte) error {
	if len(data) == 0 {
		return nil
	}
	return proto.Unmarshal(data, x)
...
func (x *RummyRemoveRoomReq) ToDB() ([]byte, error) {
	if x == nil {
		return nil, nil
	}
	return proto.Marshal(x)
...
func (x *RummyRemoveRoomRsp) SetHead(val *RspHead) {
	x.Head = val
}

func (x *RummyRemoveRoomRsp) SetRoomId(val uint64) {
	x.RoomId = val
}

func (x *RummyRemoveRoomRsp) FromDB(data []byte) error {
	if len(data) == 0 {
		return nil
	}
	return proto.Unmarshal(data, x)
...
func (x *RummyRemoveRoomRsp) ToDB() ([]byte, error) {
	if x == nil {
		return nil, nil
	}
	return proto.Marshal(x)
