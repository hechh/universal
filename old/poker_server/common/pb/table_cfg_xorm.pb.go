...
func (x *PhpConfig) SetID(val int32) {
	x.ID = val
}

func (x *PhpConfig) SetEnvType(val EnvType) {
	x.EnvType = val
}

func (x *PhpConfig) SetName(val string) {
	x.Name = val
}

func (x *PhpConfig) SetUrl(val string) {
	x.Url = val
}

func (x *PhpConfig) FromDB(data []byte) error {
	if len(data) == 0 {
		return nil
	}
	return proto.Unmarshal(data, x)
...
func (x *PhpConfig) ToDB() ([]byte, error) {
	if x == nil {
		return nil, nil
	}
	return proto.Marshal(x)
...
func (x *PhpConfigAry) SetAry(val []*PhpConfig) {
	x.Ary = val
}

func (x *PhpConfigAry) FromDB(data []byte) error {
	if len(data) == 0 {
		return nil
	}
	return proto.Unmarshal(data, x)
...
func (x *PhpConfigAry) ToDB() ([]byte, error) {
	if x == nil {
		return nil, nil
	}
	return proto.Marshal(x)
...
func (x *RummyConfig) SetDeals(val uint32) {
	x.Deals = val
}

func (x *RummyConfig) SetOutLimit(val uint32) {
	x.OutLimit = val
}
...
func (x *RummyMachineConfig) SetHalfDuration(val int64) {
	x.HalfDuration = val
}

func (x *RummyMachineConfig) SetFinSettleDuration(val int64) {
	x.FinSettleDuration = val
}
