...
func TestToken(t *testing.T) {
	buf := []byte("\n\xd0\x01eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJwb2tlcl9zZXJ2ZXIiLCJleHAiOjcxNTA2NzQ2MjAsImlhdCI6MTc1MDY3NDYyMCwidXNlcl9pZCI6MTAwMDE1Nywicm9vbV9pZCI6NDMxMTc0NDUxNn0.0Xy-sYXWwpYMoiqRwZwMZL1tP5skwif9YnOuEPNizBs")
...
func TestSngTexas(t *testing.T) {
	...
	t.Run("SngRoom", func(t *testing.T) {
		//mock.Request(uid1, roomId, pb.CMD_SNG_JOIN_ROOM_REQ, &pb.SngJoinRoomReq{MatchId: 12})
	})
