...
func (g *BuilderTexasGenerator) LoadRequest() error {
	...
	return cluster.Send(&pb.Head{
		...
		Src: framework.NewSrcRouter(uint64(pb.GeneratorType_GeneratorTypeTexas), g.GetActorName(), "LoadData"),
	})
}
...
func (g *BuilderTexasGenerator) Save() error {
	...
	head := &pb.Head{
		...
		Src: framework.NewSrcRouter(uint64(pb.GeneratorType_GeneratorTypeTexas), g.GetActorName()),
	}
