...
const (
	StatusType_REQUEST  StatusType = 0 // 请求
	StatusType_RESPONSE StatusType = 1 // 应答
)
...
type PacketHead struct {
	...
	Status         StatusType  `protobuf:"varint,1,opt,name=Status,proto3,enum=pb.StatusType" json:"Status,omitempty"`                  // 状态
	SendType       SendType    `protobuf:"varint,2,opt,name=SendType,proto3,enum=pb.SendType" json:"SendType,omitempty"`                // 传输协议
	SrcClusterType ClusterType `protobuf:"varint,3,opt,name=SrcClusterType,proto3,enum=pb.ClusterType" json:"SrcClusterType,omitempty"` // 源服务类型
	SrcClusterID   uint32      `protobuf:"varint,4,opt,name=SrcClusterID,proto3" json:"SrcClusterID,omitempty"`                         // 源集群id
	DstClusterType ClusterType `protobuf:"varint,5,opt,name=DstClusterType,proto3,enum=pb.ClusterType" json:"DstClusterType,omitempty"` // 目标集群类型
	DstClusterID   uint32      `protobuf:"varint,6,opt,name=DstClusterID,proto3" json:"DstClusterID,omitempty"`                         // 目标集群id 大于0优先
	ApiCode        int32       `protobuf:"varint,7,opt,name=ApiCode,proto3" json:"ApiCode,omitempty"`                                   // 请求接口唯一id
	SeqID          uint32      `protobuf:"varint,8,opt,name=SeqID,proto3" json:"SeqID,omitempty"`                                       // 序列号
	Time           int64       `protobuf:"varint,9,opt,name=Time,proto3" json:"Time,omitempty"`                                         // 请求时间戳
	UID            uint64      `protobuf:"varint,10,opt,name=UID,proto3" json:"UID,omitempty"`                                          // 目标玩家uid
}
...
func (x *PacketHead) GetStatus() StatusType {
	if x != nil {
		return x.Status
	}
	return StatusType_REQUEST
}
...
var file_packet_proto_rawDesc = []byte{
	...
	,
	...
	,
}
...
var file_packet_proto_goTypes = []interface{}{
	...
	(SendType)(0),         // 2: pb.SendType
	(*ClusterNode)(nil),   // 3: pb.ClusterNode
	(*PacketHead)(nil),    // 4: pb.PacketHead
	(*Packet)(nil),        // 5: pb.Packet
	(*RpcHead)(nil),       // 6: pb.RpcHead
	(*ActorRequest)(nil),  // 7: pb.ActorRequest
	(*ActorResponse)(nil), // 8: pb.ActorResponse
}
var file_packet_proto_depIdxs = []int32{
	0, // 0: pb.ClusterNode.ClusterType:type_name -> pb.ClusterType
	1, // 1: pb.PacketHead.Status:type_name -> pb.StatusType
	2, // 2: pb.PacketHead.SendType:type_name -> pb.SendType
	0, // 3: pb.PacketHead.SrcClusterType:type_name -> pb.ClusterType
	0, // 4: pb.PacketHead.DstClusterType:type_name -> pb.ClusterType
	4, // 5: pb.Packet.Head:type_name -> pb.PacketHead
	6, // 6: pb.ActorResponse.Head:type_name -> pb.RpcHead
