...
func (d *LoginReq) SetHead(v *RspHead) {
	d.Head = v
}
func (d *LoginReq) SetList(v []*LoginRsp) {
	d.List = v
}
func (d *LoginReq) SetSet(v []int64) {
	d.Set = v
}
func (d *LoginReq) SetFFF(v []*protoimpl.UnknownFields) {
	d.FFF = v
}
func (d *LoginReq) SetData(v map[uint64]*LoginRsp) {
	d.Data = v
}
func (d *LoginReq) SetRelation(v map[uint64]int64) {
	d.Relation = v
}
