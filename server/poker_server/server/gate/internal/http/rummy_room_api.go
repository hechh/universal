...
func rummyRoomList(w http.ResponseWriter, r *http.Request) {
	// 1. 只允许GET方法
	rsp := &pb.RummyRoomListRsp{}
	...
	head := framework.NewHead(framework.NewMatchRouter(uint64(gameType)<<32|uint64(coinType), "MatchRummyRoom", "RoomListReq"), pb.RouterType_RouterTypeUid, 0)
	req := &pb.RummyRoomListReq{
