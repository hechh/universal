...
// @pbtool:string|poker|login_session:session_id|#玩家登录session操作
type LoginSession struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SessionId     string                 `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`     // 会话ID
	AccountId     uint64                 `protobuf:"varint,2,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`    // 用户ID
...
func (x *LoginSession) GetAccountId() uint64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *LoginSession) GetCreateTime() int64 {
	if x != nil {
		return x.CreateTime
	}
	return 0
...
func (x *LoginSession) GetExpireTime() int64 {
	if x != nil {
		return x.ExpireTime
	}
	return 0
...
var file_redis_proto_rawDesc = string([]byte{
	...
	0x6f, 0x6b, 0x65, 0x72, 0x22, 0x8e, 0x01, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53, 0x65,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_redis_proto_goTypes = []any{
	(*LoginSession)(nil), // 0: poker.LoginSession
}
