...
type ITable interface {
	Get(pb.IdType, uint64) (IRouter, error)  // 获取路由信息
	Add(pb.IdType, uint64, *pb.Router) error // 设置路由信息
...
type IBus interface {
	...
	Response(*pb.Head, proto.Message) error                     // 响应消息
	Close() error                                               // 关闭网络
}
...
type INet interface {
	...
	WriteMsg(*pb.Head, proto.Message) error // 发送消息
