...
type PBEjectAdvertInfo struct {
	...
	Id              uint32 `protobuf:"varint,1,opt,name=Id,proto3" json:"Id,omitempty"`                           // 广告ID
	NextRefreshTime uint64 `protobuf:"varint,2,opt,name=NextRefreshTime,proto3" json:"NextRefreshTime,omitempty"` // 下次刷新时间 0无领取
}

func (x *PBEjectAdvertInfo) Reset() {
	*x = PBEjectAdvertInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *PBEjectAdvertInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PBEjectAdvertInfo) ProtoMessage() {}

func (x *PBEjectAdvertInfo) ProtoReflect() protoreflect.Message {
	mi := &file_playerStruct_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PBEjectAdvertInfo.ProtoReflect.Descriptor instead.
func (*PBEjectAdvertInfo) Descriptor() ([]byte, []int) {
	return file_playerStruct_proto_rawDescGZIP(), []int{9}
}

func (x *PBEjectAdvertInfo) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PBEjectAdvertInfo) GetNextRefreshTime() uint64 {
	if x != nil {
...
type PBPlayerSystemCommon struct {
	...
	EjectAdvertInfo     *PBEjectAdvertInfo  `protobuf:"bytes,9,opt,name=EjectAdvertInfo,proto3" json:"EjectAdvertInfo,omitempty"`                 // 弹出广告数据
}
...
func (x *PBPlayerSystemCommon) GetEjectAdvertInfo() *PBEjectAdvertInfo {
	if x != nil {
...
type PBBattleHookInfo struct {
	...
	PassRewards    []uint64         `protobuf:"varint,7,rep,packed,name=PassRewards,proto3" json:"PassRewards,omitempty"` // 通关领奖状态
}
...
func (x *PBBattleHookInfo) GetPassRewards() []uint64 {
	if x != nil {
		return x.PassRewards
	}
	return nil
}
...
type PBShopInfo struct {
	...
	HaveRed         uint32      `protobuf:"varint,4,opt,name=HaveRed,proto3" json:"HaveRed,omitempty"`                 // 是否有红点
}
...
func (x *PBShopInfo) GetHaveRed() uint32 {
	if x != nil {
		return x.HaveRed
	}
	return 0
...
type PBDrawPrizeInfo struct {
	...
	Rate2    uint32       `protobuf:"varint,4,opt,name=Rate2,proto3" json:"Rate2,omitempty"`      // 概率万分比 用于碎片 0不展示
}
...
func (x *PBDrawPrizeInfo) GetRate2() uint32 {
	if x != nil {
		return x.Rate2
	}
	return 0
...
type PBFirstCharge struct {
	...
	ActiveTime    uint64 `protobuf:"varint,2,opt,name=ActiveTime,proto3" json:"ActiveTime,omitempty"`       // 激活时间 充值时间充值时间
	PrizeDay      uint32 `protobuf:"varint,3,opt,name=PrizeDay,proto3" json:"PrizeDay,omitempty"`           // 领取的最新奖励天数
	OpenTime      uint64 `protobuf:"varint,4,opt,name=OpenTime,proto3" json:"OpenTime,omitempty"`           // 开启时间
}
...
func (x *PBFirstCharge) GetOpenTime() uint64 {
	if x != nil {
		return x.OpenTime
	}
	return 0
...
type PBPlayerSystemChampionship struct {
	...
	HookHasReward   uint32           `protobuf:"varint,1,opt,name=HookHasReward,proto3" json:"HookHasReward,omitempty"`     // 0表示没加入,1表示加入,2表示领完奖
	...
	Hook            *PBTaskStageInfo `protobuf:"bytes,5,opt,name=Hook,proto3" json:"Hook,omitempty"`                        // 挂机关卡排行榜任务
...
type PBPlayerSystemRepairData struct {
	...
	Version     uint32 `protobuf:"varint,1,opt,name=Version,proto3" json:"Version,omitempty"`         // 当前版本
	VersionTime uint64 `protobuf:"varint,2,opt,name=VersionTime,proto3" json:"VersionTime,omitempty"` // 修复时间
}

func (x *PBPlayerSystemRepairData) Reset() {
	*x = PBPlayerSystemRepairData{}
	if protoimpl.UnsafeEnabled {
...
func (x *PBPlayerSystemRepairData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PBPlayerSystemRepairData) ProtoMessage() {}

func (x *PBPlayerSystemRepairData) ProtoReflect() protoreflect.Message {
	mi := &file_playerStruct_proto_msgTypes[58]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PBPlayerSystemRepairData.ProtoReflect.Descriptor instead.
func (*PBPlayerSystemRepairData) Descriptor() ([]byte, []int) {
	return file_playerStruct_proto_rawDescGZIP(), []int{58}
}

func (x *PBPlayerSystemRepairData) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *PBPlayerSystemRepairData) GetVersionTime() uint64 {
	if x != nil {
...
type PBPlayerSystem struct {
	...
	RepairData   *PBPlayerSystemRepairData   `protobuf:"bytes,16,opt,name=RepairData,proto3" json:"RepairData,omitempty"`     // 数据修复
}
...
func (x *PBPlayerSystem) GetRepairData() *PBPlayerSystemRepairData {
	if x != nil {
		return x.RepairData
	}
	return nil
...
type PBPlayerHero struct {
	...
	GlobalRandHeroProf   []uint32          `protobuf:"varint,8,rep,packed,name=GlobalRandHeroProf,proto3" json:"GlobalRandHeroProf,omitempty"` // 5蓝职业+5蓝职业 5紫色职业 5紫色职业 当前蓝色索引  当前紫色索引 全局前10个蓝色和全局前10个紫色 5个职业乱序排序为一轮，保护两系统前两轮（第二轮重新乱序）
}
...
func (x *PBPlayerHero) GetGlobalRandHeroProf() []uint32 {
	if x != nil {
		return x.GlobalRandHeroProf
	}
	return nil
}
...
func (x *PBPlayerCrystal) Reset() {
	*x = PBPlayerCrystal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_playerStruct_proto_msgTypes[97]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PBPlayerCrystal) Descriptor() ([]byte, []int) {
	return file_playerStruct_proto_rawDescGZIP(), []int{97}
}
...
var file_playerStruct_proto_rawDesc = []byte{
	...
	,
	...
	0x0c, 0x44, 0x72, 0x6f, 0x70, 0x42, 0x6f, 0x78, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x91, 0x02,
	...
	0x0e, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x4c, 0x6f, 0x6f, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12,
	0x20, 0x0a, 0x0b, 0x50, 0x61, 0x73, 0x73, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x18, 0x07,
	0x20, 0x03, 0x28, 0x04, 0x52, 0x0b, 0x50, 0x61, 0x73, 0x73, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
	0x73, 0x22, 0xb1, 0x01, 0x0a, 0x12, 0x50, 0x42, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x4e, 0x6f,
	0x72, 0x6d, 0x61, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x37, 0x0a, 0x07, 0x4d, 0x61, 0x70, 0x49,
	...
	0x6f, 0x12, 0x1e, 0x0a, 0x0a, 0x50, 0x72, 0x69, 0x7a, 0x65, 0x4d, 0x61, 0x70, 0x49, 0x64, 0x18,
	...
	,
	...
	,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x41, 0x0a, 0x0b, 0x52, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x9b, 0x01, 0x0a, 0x16, 0x50, 0x42, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x47,
	0x72, 0x6f, 0x77, 0x52, 0x6f, 0x61, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	...
	0x69, 0x6d, 0x65, 0x12, 0x39, 0x0a, 0x08, 0x54, 0x61, 0x73, 0x6b, 0x4c, 0x69, 0x73, 0x74, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x53, 0x74,
	0x72, 0x75, 0x63, 0x74, 0x2e, 0x50, 0x42, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x61, 0x67, 0x65,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x54, 0x61, 0x73, 0x6b, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x90,
	0x01, 0x0a, 0x14, 0x50, 0x42, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x43, 0x68, 0x61,
	0x72, 0x67, 0x65, 0x47, 0x69, 0x66, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x01, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_playerStruct_proto_msgTypes = make([]protoimpl.MessageInfo, 98)
var file_playerStruct_proto_goTypes = []interface{}{
	...
	(*PBEjectAdvertInfo)(nil),          // 9: playerStruct.PBEjectAdvertInfo
	...
	(*PBPlayerSystemRepairData)(nil),   // 58: playerStruct.PBPlayerSystemRepairData
	(*PBPlayerSystem)(nil),             // 59: playerStruct.PBPlayerSystem
	(*PBGeneTag)(nil),                  // 60: playerStruct.PBGeneTag
	(*PBGeneRobot)(nil),                // 61: playerStruct.PBGeneRobot
	(*PBGeneScheme)(nil),               // 62: playerStruct.PBGeneScheme
	(*PBPlayerSystemGene)(nil),         // 63: playerStruct.PBPlayerSystemGene
	(*PBPlayerSystemOffline)(nil),      // 64: playerStruct.PBPlayerSystemOffline
	(*PBClientData)(nil),               // 65: playerStruct.PBClientData
	(*PBPlayerClientData)(nil),         // 66: playerStruct.PBPlayerClientData
	(*PBMail)(nil),                     // 67: playerStruct.PBMail
	(*PBPlayerMail)(nil),               // 68: playerStruct.PBPlayerMail
	(*PBItem)(nil),                     // 69: playerStruct.PBItem
	(*PBPlayerBag)(nil),                // 70: playerStruct.PBPlayerBag
	(*PBEquipmentProp)(nil),            // 71: playerStruct.PBEquipmentProp
	(*PBEquipment)(nil),                // 72: playerStruct.PBEquipment
	(*PBPlayerEquipment)(nil),          // 73: playerStruct.PBPlayerEquipment
	(*PBHero)(nil),                     // 74: playerStruct.PBHero
	(*PBHeroBook)(nil),                 // 75: playerStruct.PBHeroBook
	(*PBHeroTeamList)(nil),             // 76: playerStruct.PBHeroTeamList
	(*PBPlayerHero)(nil),               // 77: playerStruct.PBPlayerHero
	(*PBAddItemData)(nil),              // 78: playerStruct.PBAddItemData
	(*PBOfflineData)(nil),              // 79: playerStruct.PBOfflineData
	(*PBPlayerData)(nil),               // 80: playerStruct.PBPlayerData
	(*PBChatMsgInfo)(nil),              // 81: playerStruct.PBChatMsgInfo
	(*PBAllChatMsgInfo)(nil),           // 82: playerStruct.PBAllChatMsgInfo
	(*RankInfo)(nil),                   // 83: playerStruct.RankInfo
	(*PBAddItem)(nil),                  // 84: playerStruct.PBAddItem
	(*PBPlayerBattleData)(nil),         // 85: playerStruct.PBPlayerBattleData
	(*PBNotice)(nil),                   // 86: playerStruct.PBNotice
	(*PBPropInfo)(nil),                 // 87: playerStruct.PBPropInfo
	(*PBJsonInfo)(nil),                 // 88: playerStruct.PBJsonInfo
	(*PBCrystalProp)(nil),              // 89: playerStruct.PBCrystalProp
	(*PBCrystalRobot)(nil),             // 90: playerStruct.PBCrystalRobot
	(*PBCrystal)(nil),                  // 91: playerStruct.PBCrystal
	(*PBCrystalBook)(nil),              // 92: playerStruct.PBCrystalBook
	(*EntryCondition)(nil),             // 93: playerStruct.EntryCondition
	(*EntryEffectValue)(nil),           // 94: playerStruct.EntryEffectValue
	(*EntryEffectData)(nil),            // 95: playerStruct.EntryEffectData
	(*EntryEffect)(nil),                // 96: playerStruct.EntryEffect
	(*PBPlayerCrystal)(nil),            // 97: playerStruct.PBPlayerCrystal
	(LoginState)(0),                    // 98: common.LoginState
	(EmBattleType)(0),                  // 99: common.EmBattleType
	(EmTaskState)(0),                   // 100: common.EmTaskState
	(EmMailState)(0),                   // 101: common.EmMailState
	(EmDoingType)(0),                   // 102: common.EmDoingType
	(EmPlayerOfflineType)(0),           // 103: common.EmPlayerOfflineType
}
var file_playerStruct_proto_depIdxs = []int32{
	...
	98,  // 1: playerStruct.PBPlayerBase.LoginState:type_name -> common.LoginState
	...
	9,   // 6: playerStruct.PBPlayerSystemCommon.EjectAdvertInfo:type_name -> playerStruct.PBEjectAdvertInfo
	...
	99,  // 13: playerStruct.BattleInfo.BattleType:type_name -> common.EmBattleType
	...
	72,  // 26: playerStruct.PBShopGoodInfo.Equipment:type_name -> playerStruct.PBEquipment
	...
	84,  // 29: playerStruct.PBShopGoodCfg.NeedItem:type_name -> playerStruct.PBAddItem
	78,  // 30: playerStruct.PBShopGoodCfg.AddItem:type_name -> playerStruct.PBAddItemData
	...
	84,  // 34: playerStruct.PBDrawPrizeInfo.ItemList:type_name -> playerStruct.PBAddItem
	...
	100, // 42: playerStruct.PBTaskStageInfo.State:type_name -> common.EmTaskState
	...
	46,  // 46: playerStruct.PBPlayerSystemChampionship.Hook:type_name -> playerStruct.PBTaskStageInfo
	...
	63,  // 67: playerStruct.PBPlayerSystem.Gene:type_name -> playerStruct.PBPlayerSystemGene
	64,  // 68: playerStruct.PBPlayerSystem.Offline:type_name -> playerStruct.PBPlayerSystemOffline
	...
	58,  // 74: playerStruct.PBPlayerSystem.RepairData:type_name -> playerStruct.PBPlayerSystemRepairData
	60,  // 75: playerStruct.PBGeneRobot.Tags:type_name -> playerStruct.PBGeneTag
	60,  // 76: playerStruct.PBGeneScheme.Tags:type_name -> playerStruct.PBGeneTag
	61,  // 77: playerStruct.PBGeneScheme.Robots:type_name -> playerStruct.PBGeneRobot
	62,  // 78: playerStruct.PBPlayerSystemGene.Schemes:type_name -> playerStruct.PBGeneScheme
	78,  // 79: playerStruct.PBPlayerSystemOffline.Rewards:type_name -> playerStruct.PBAddItemData
	65,  // 80: playerStruct.PBPlayerClientData.ClientDataList:type_name -> playerStruct.PBClientData
	101, // 81: playerStruct.PBMail.State:type_name -> common.EmMailState
	78,  // 82: playerStruct.PBMail.Item:type_name -> playerStruct.PBAddItemData
	67,  // 83: playerStruct.PBPlayerMail.MailList:type_name -> playerStruct.PBMail
	69,  // 84: playerStruct.PBPlayerBag.ItemList:type_name -> playerStruct.PBItem
	0,   // 85: playerStruct.PBPlayerBag.DailyBuyItem:type_name -> playerStruct.PBU32U32
	71,  // 86: playerStruct.PBEquipment.MainProp:type_name -> playerStruct.PBEquipmentProp
	71,  // 87: playerStruct.PBEquipment.MinorPropList:type_name -> playerStruct.PBEquipmentProp
	71,  // 88: playerStruct.PBEquipment.VicePropList:type_name -> playerStruct.PBEquipmentProp
	71,  // 89: playerStruct.PBEquipment.LinkPropList:type_name -> playerStruct.PBEquipmentProp
	72,  // 90: playerStruct.PBPlayerEquipment.equipmentList:type_name -> playerStruct.PBEquipment
	72,  // 91: playerStruct.PBPlayerEquipment.HookEquipmentList:type_name -> playerStruct.PBEquipment
	74,  // 92: playerStruct.PBPlayerHero.HeroList:type_name -> playerStruct.PBHero
	76,  // 93: playerStruct.PBPlayerHero.TeamList:type_name -> playerStruct.PBHeroTeamList
	0,   // 94: playerStruct.PBPlayerHero.UpStarCount:type_name -> playerStruct.PBU32U32
	75,  // 95: playerStruct.PBPlayerHero.HeroBookList:type_name -> playerStruct.PBHeroBook
	102, // 96: playerStruct.PBAddItemData.DoingType:type_name -> common.EmDoingType
	72,  // 97: playerStruct.PBAddItemData.Equipment:type_name -> playerStruct.PBEquipment
	103, // 98: playerStruct.PBOfflineData.OfflineType:type_name -> common.EmPlayerOfflineType
	67,  // 99: playerStruct.PBOfflineData.Mail:type_name -> playerStruct.PBMail
	78,  // 100: playerStruct.PBOfflineData.Item:type_name -> playerStruct.PBAddItemData
	102, // 101: playerStruct.PBOfflineData.DoingType:type_name -> common.EmDoingType
	4,   // 102: playerStruct.PBPlayerData.Base:type_name -> playerStruct.PBPlayerBase
	59,  // 103: playerStruct.PBPlayerData.System:type_name -> playerStruct.PBPlayerSystem
	70,  // 104: playerStruct.PBPlayerData.Bag:type_name -> playerStruct.PBPlayerBag
	73,  // 105: playerStruct.PBPlayerData.Equipment:type_name -> playerStruct.PBPlayerEquipment
	66,  // 106: playerStruct.PBPlayerData.Client:type_name -> playerStruct.PBPlayerClientData
	77,  // 107: playerStruct.PBPlayerData.Hero:type_name -> playerStruct.PBPlayerHero
	68,  // 108: playerStruct.PBPlayerData.Mail:type_name -> playerStruct.PBPlayerMail
	97,  // 109: playerStruct.PBPlayerData.Crystal:type_name -> playerStruct.PBPlayerCrystal
	3,   // 110: playerStruct.PBChatMsgInfo.Display:type_name -> playerStruct.PBPlayerBaseDisplay
	81,  // 111: playerStruct.PBAllChatMsgInfo.Msg:type_name -> playerStruct.PBChatMsgInfo
	3,   // 112: playerStruct.RankInfo.Display:type_name -> playerStruct.PBPlayerBaseDisplay
	3,   // 113: playerStruct.PBPlayerBattleData.Display:type_name -> playerStruct.PBPlayerBaseDisplay
	74,  // 114: playerStruct.PBPlayerBattleData.HeroList:type_name -> playerStruct.PBHero
	21,  // 115: playerStruct.PBPlayerBattleData.ClientData:type_name -> playerStruct.PBBattleClientData
	94,  // 116: playerStruct.EntryEffectData.Values:type_name -> playerStruct.EntryEffectValue
	95,  // 117: playerStruct.EntryEffect.List:type_name -> playerStruct.EntryEffectData
	92,  // 118: playerStruct.PBPlayerCrystal.Book:type_name -> playerStruct.PBCrystalBook
	90,  // 119: playerStruct.PBPlayerCrystal.Robots:type_name -> playerStruct.PBCrystalRobot
	91,  // 120: playerStruct.PBPlayerCrystal.Crystals:type_name -> playerStruct.PBCrystal
	93,  // 121: playerStruct.PBPlayerCrystal.Conditions:type_name -> playerStruct.EntryCondition
	96,  // 122: playerStruct.PBPlayerCrystal.Effects:type_name -> playerStruct.EntryEffect
...
func file_playerStruct_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_playerStruct_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PBEjectAdvertInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_playerStruct_proto_msgTypes[58].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PBPlayerSystemRepairData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_playerStruct_proto_msgTypes[97].Exporter = func(v interface{}, i int) interface{} {
